        ...
        <div>
            ...
            <div className="px-6 md:px-[200px] mt-8">
                ...
                <form className="flex flex-col w-full space-y-4 md:space-y-8 mt-4">
                    ...
                    <textarea rows={15} cols={30} className="px-4 py-2 outline-none" placeholder="Enter Post Discription"/>
                    <button className="bg-black w-full md:w-[20%] mx-auto text-white font-semibold px-4 py-2 md:text-xl text-lg rounded-md">Update Post</button>
                </form>
            </div>
            <Footer />
        </div>
